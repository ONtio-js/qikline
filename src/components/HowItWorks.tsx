...
const HowItWorks = ({icon,title,description,key}:{icon:React.ReactNode,title:string,description:string,key:number}) => {
  return (
    <div key={key} className='bg-blue-700/80 md:bg-none flex flex-col items-center gap-5 md:max-w-[23rem] group hover:bg-blue-600/80 p-10 transition-all duration-500 ease-in-out rounded-2xl'>
